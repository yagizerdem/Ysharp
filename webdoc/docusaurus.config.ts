...
const config: Config = {
  ...
  url: "https://yagizerdem.github.io",
  ...
  organizationName: "yagizerdem", // Usually your GitHub org/user name.
  projectName: "Ysharp", // Usually your repo name.
