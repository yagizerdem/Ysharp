...
public class PutFn extends Function.NativeFunction implements Callable {
    ...
    public Variable.Variant call(Interpreter interpreter,
        ...
        if (!(urlValue.value instanceof String url)) {
            throw new YsharpException(
                    ...
                    -1,
                    "HTTP.put(url, body) expects url to be string."
            );
        }
        ...
        if (!(bodyValue.value instanceof String body)) {
            throw new YsharpException(
                    YsharpException.YsharpErrorType.PROCESS,
                    -1,
                    "HTTP.put(url, body) expects body to be string."
            );
        }
        ...
        try {
            ...
            throw new YsharpException(
                    YsharpException.YsharpErrorType.PROCESS,
                    -1,
                    "HTTP.put failed: invalid URL '" + url + "'."
            );
