...
public class AcquireUninterruptiblyFn extends Function.NativeFunction {
    ...
    public Variable.Variant call(Interpreter interpreter,
        ...
        if (arguments.size() > 1) {
            throw new YsharpException(
                    ...
                    -1,
                    "acquireUninterruptibly expects 0 or 1 arguments."
            );
        }
        ...
        if (!arguments.isEmpty()) {
            ...
            if (permits < 0) {
                throw new YsharpException(
                        YsharpException.YsharpErrorType.PROCESS,
                        -1,
                        "acquireUninterruptibly permits must be >= 0."
                );
            }
        }
