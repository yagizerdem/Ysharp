...
public class ReplaceFirstFn extends Function.NativeFunction implements Callable {
    ...
    public Variable.Variant call(Interpreter interpreter,
        ...
        try {
            String result = matcher.matcher.replaceFirst(replacement);
            return new Variable.Variant(result);
        } catch (Exception e) {
            throw new YsharpException(
                    YsharpException.YsharpErrorType.PROCESS,
                    -1,
                    "replaceFirst() failed: " + e.getMessage()
            );
        }
    }
