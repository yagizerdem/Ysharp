...
public class MinusDaysFn extends Function.NativeFunction {
    ...
    public Variable.Variant call(Interpreter interpreter,
        ...
        try {
            ...
            LocalDateTime result = dateTime.minusDays(days);
            ...
            throw new YsharpException(
                    ...
                    -1,
                    "DateTime.minusDays expected ISO datetime string, got: " + value
            );
        }
    }
