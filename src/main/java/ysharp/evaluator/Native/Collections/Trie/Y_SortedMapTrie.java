...
public class Y_SortedMapTrie {
    ...
    // helper
    private static Y_SortedMapTrie.Y_SortedMapTrieObject requireTrieThis(Interpreter interpreter) {
        ...
        if (!(obj instanceof Y_SortedMapTrie.Y_SortedMapTrieObject)) {
            throw new YsharpError(
                    YsharpError.YsharpErrorType.PROCESS,
                    0,
        ...
        return (Y_SortedMapTrie.Y_SortedMapTrieObject) obj;
    }

    static {
        Y_SortedMapTrie_Prototype = new RuntimeObject() {
        ...
        class ToStringFn extends Function.NativeFunction {
            ...
            public Variable.Variant call(Interpreter interpreter,
                ...
                Y_SortedMapTrieObject trie = requireTrieThis(interpreter);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(toString.getFnName(), toStringVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(insert.getFnName(), insertVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(get.getFnName(), getVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(contains.getFnName(), containsVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(deleteKey.getFnName(), deleteKeyVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(getKeySuggestions.getFnName(), getKeySuggestionsVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(getValueSuggestions.getFnName(), getValueSuggestionsVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(keys.getFnName(), keysVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(values.getFnName(), valuesVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(size.getFnName(), sizeVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(isEmpty.getFnName(), isEmptyVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(clear.getFnName(), clearVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(fastClear.getFnName(), fastClearVar);
        ...
        Y_SortedMapTrie.Y_SortedMapTrie_Prototype.set(print.getFnName(), printVar);

    }

    public static RuntimeObject Y_SortedMapTrie_Prototype;

    public static class Y_SortedMapTrieObject extends RuntimeObject {

        // Backed by MapTrie<Variable.Variant> — keys are lowercased+trimmed strings
        final MapTrie<Variable.Variant> data;

        public Y_SortedMapTrieObject() {
            this.data = new MapTrie<>();
            this.prototype = Y_SortedMapTrie_Prototype;
        }
    ...
    public static class Y_SortedMapTrieInit extends Function.NativeFunction {
        ...
        public Variable.Variant call(Interpreter interpreter,
            ...
            Y_SortedMapTrieObject newTrie = new Y_SortedMapTrieObject();
    ...
    public static void Register(Interpreter interpreter) throws Exception {
        Y_SortedMapTrie.Y_SortedMapTrieInit trieCtor = new Y_SortedMapTrie.Y_SortedMapTrieInit();
